...
# Importer votre adaptateur Teachable Machine
...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "model", "teachable_machine")  # Ajustez selon votre structure
os.makedirs(SAVE_DIR, exist_ok=True)

# Configuration de l'app
st.set_page_config(page_title="YOLO_Danse avec Teachable Machine")
